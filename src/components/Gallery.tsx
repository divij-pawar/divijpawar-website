        ...
        {tab === 'general' && (
          <div>
            {galleryImages.length === 0 ? (
              <EmptyState message="Add images to galleryImages in src/data/portfolioData.ts to populate this gallery." />
            ) : (
              <MasonryGrid>
        ...
        {tab === 'projects' && (
          <div>
            {projectImages.length === 0 ? (
              <EmptyState message="Add an images[] array to each project in src/data/portfolioData.ts to show project photos here." />
            ) : (
              <MasonryGrid>
