    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-16" style={{ position: 'relative', zIndex: 1, width: '100%' }}>
        ...
        <div className="font-mono" style={{
          ...
          MS Computer Science · UMass Lowell
        </div>
        ...
        <h1 className="font-display" style={{
          ...
          Divij<br />
          <span style={{ color: 'var(--accent)' }}>Pawar
        ...
        <p className="font-display" style={{
          ...
          Building resilient backend systems and autonomous agents.
        </p>
        ...
        <div style={{
          ...
          {[
            { n: '6',    l: 'Microservices Shipped' },
            { n: '700+', l: 'Live Clients Served' },
            { n: '40%',  l: 'Latency Reduction' },
          ].map((s, i) => (
